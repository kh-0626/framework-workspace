...
public class BoardController {
	...
	public ModelAndView newBoard(ModelAndView mv,
		...
		// 첨부파일의 존재유무
		// => 차이점 => MutipartFile타입의 filename필드값으로 확인을 하겠다.
		...
		public ModelAndView doSearch(@RequestParam(name="condition") String condition,
			...
			mv.addObject("map", list).setViewName("board/boards_list");
		...
		public String insertReply(ReplyDTO reply) {			
			...
			boardService.insertBoard(null, null, null);
			
			
			
			return String.valueOf(boardService.insertReply());
		}
