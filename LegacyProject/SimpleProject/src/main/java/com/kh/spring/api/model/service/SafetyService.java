...
public class SafetyService {
	...
	public String requestHospitalApi() throws IOException{
		...
		sb.append("?serviceKey=BCKIK07B3SEM7Y7W");
	...
	public String requestMessage(int pageNo) {
		...
		final String SERVICE_KEY = "F2YPNZ64B5M88601";
	    ...
	    public String getItems(String query) {
	        String clientId = "vvNCqownmMMVIV3feJvv"; //애플리케이션 클라이언트 아이디
	        String clientSecret = "9QEBVZLAOw"; //애플리케이션 클라이언트 시크릿
