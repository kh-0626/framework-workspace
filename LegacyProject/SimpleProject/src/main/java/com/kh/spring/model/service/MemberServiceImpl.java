...
import com.kh.spring.exception.controller.PasswordNotMatchException;
	...
	*/
	...
	public void update(MemberDTO member, HttpSession session) {
		...
		if(!member.getMemberId()
				.equals(((MemberDTO)session.getAttribute("loginMember")).getMemberId())) {
